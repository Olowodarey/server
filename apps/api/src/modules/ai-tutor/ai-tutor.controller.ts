...
export class AiTutorController {
  ...
  @ApiOperation({
    ...
    description:
      "Generate random practice questions for any module or general knowledge. No rewards or tracking.",
  })
  ...
  @ApiOperation({
    summary:
      "Check practice answer and get feedback (no XP, no progress tracking)",
    description:
      "Submit an answer to a practice question and receive feedback without affecting progress.",
  })
